...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (isCharging) rb.velocity = Vector3.zero;
    ...
    private void MyInput()
    {
        ...
        {
            sr.flipX = false;
            chargeLight.transform.localPosition = new Vector3(-0.2f, 0, - 0.2f);
        }
    ...
    private void disableChargeLight()
    {
